...
* протестировать последний коммит
* выделить отрытия крипто-контейнеров и проверку физических томов lvm в отдельную функцию и использовать в обоих случаях
* протестировать что будет если указать uuid не luks или не существующего устройства
