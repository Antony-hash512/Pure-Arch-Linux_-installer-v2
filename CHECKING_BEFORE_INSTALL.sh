...
: <<'TODO'
* разобраться откуда берётся ошибка при закрытии крипто-контейнера
* проверить почему не отображается ошибка о нехватке свободного места в lv lvm, исправить
