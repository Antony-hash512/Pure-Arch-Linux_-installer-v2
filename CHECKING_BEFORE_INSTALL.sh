...
* автоматически убирать пробелы в тегах pv-volumes-uuids
* выделить открытия крипто-контейнеров и проверку физических томов lvm в отдельную функцию и использовать в обоих случаях
