...
: <<'TODO'
* написать документацию текущей реализации для лучшего понимания 
какие теги используются и как от друг друга зависят
(в заметках Obsidian и/или в md-файле самого репозитория)
