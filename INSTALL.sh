...
: <<'TODO'
* разобраться почему в vm_test16_step1 установленная система не открывается
(возможно, нужно переставить местами хуки или обновлять initramfs после каждого пакета)
