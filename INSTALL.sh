#!/bin/bash
: <<'TODO'
* переписать все наработки, используя принцип KISS с более активным разбиением на функции
* написать код для всех случаев с lvm, btrfs и опций шифрования
* придумать сбособ для отображения информации о существующих разделах и того что прописано в xml-файле
