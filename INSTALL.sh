...
: <<'TODO'
* /efi нужно брать из настроек
* проверить есть ли в функции get_btrfs_subvolumes проверка на наличие точки монтирования для btrfs устройства
...
* дописать буты c xml-файл для всех тестов и расширения архивов homefiles
