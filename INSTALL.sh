...
: <<'TODO'
* провести траблшутинг (описан в заметке Obsidian)
    ...
    * протестировать исправленный вариант на vm: провести тесты 2,4,5 (пока без mapper)
...
* дописать буты (wtf???) и расширения архивов homefiles
* не пытаться "скачивать" пакманом ошибку питоновского скрипта
