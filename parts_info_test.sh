...
+ исправить баги с отмонтированием временных точек монтирования когда открыт криптоконтейнер
...
+ сделать возможным запуск скрипта с различными параметрами (автовыбор компонентов и альтернативный xml-файл)
TODO
