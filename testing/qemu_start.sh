...
qemu-system-x86_64 \
    ...
    -virtfs local,path=/home/share/git/Cryptful-Arch-Linux_-installer-v2/,mount_tag=inst_scripts,security_model=none \
    -virtfs local,path=/home/share/git/Cryptful-Arch-Linux_-installer-v2/cash-repo/,mount_tag=pkgcache,security_model=none \
    -cdrom /home/share/data/extra/torrents/archlinux-2025.07.01-x86_64.iso \
